...
const Nav = () => {
  ...
  return (
    ...
    h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full
    xl:w-16 xl:max-w-md xl:h-screen">
      {/* inner */}
      <div className="flex w-full xl:flex-col items-center justify-between
      gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] bg-white/10 xl:h-max py-8
            ...
            >
              ...
              <div className=" absolute pr-14 right-0 hidden xl:group-hover:flex">
                ...
                items-center p-[6px] rounded-[3px]">
                  <div className="text-[12px] leading-none font-extrabold capitalize ">
                    { link.name }
                  </div>
                  {/* triangle */}
